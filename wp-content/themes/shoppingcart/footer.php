...
$footer_column = $shoppingcart_settings['shoppingcart_footer_column_section'];
	...
	if ( is_active_sidebar( 'shoppingcart_footer_options' ) ) :
		...
		<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
		 ...
		 <a title="<?php echo esc_attr__( 'WordPress', 'shoppingcart' );?>" target="_blank" href="<?php echo esc_url( 'https://wordpress.org' );?>"><?php esc_html_e('All Right Reserved','shoppingcart'); ?></a> |

						<?php esc_html_e('Customized by:','shoppingcart'); ?> <a title="<?php echo esc_attr__( 'Amresh Roy', 'shoppingcart' ); ?>" target="_blank" href="<?php echo esc_url( 'https://amreshray.com' ); ?>"><?php esc_html_e('Amresh Roy','shoppingcart');?></a> 
